    ...
    <div class="wrapper">
      ...
      <div class="form-container">
        ...
        <div class="form-inner">
          ...
          <form action="SignUp2.php" name="myform" class="signup" method="post" onsubmit="return validation()">
            <div class="field">
              <input type="text" name="username" placeholder="username" required>
            </div>
            <div class="field">
...
<script>
               function passVal(password)
                {
                    ...
                    {
                        var pc = password[i].charCodeAt(0);
  ...
  if(!(passVal(password)))
  {
    alert("Password should contain atleast 1 digit and 1 special character");
    return false;
  }
  return true;
  }
